...
export class EmailService {
  ...
  async sendHotelBookingMail(sendMailDto: CreateEmailDto,
    bookingId: string,
    hotelName: string,
    checkInDate: string,
    checkOutDate: string,
   ...
   async sendHotelBookingMailAdmin(sendMailDto: CreateEmailDto,
    bookingId: string,
    hotelName: string,
    checkInDate: string,
    checkOutDate: string,
  ...
  async flightConfirmationMail(sendMailDto: CreateEmailDto,pdf:string){
