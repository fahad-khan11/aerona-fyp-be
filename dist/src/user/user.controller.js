...
const user_swagger_schema_1 = require("./user.swagger-schema");
...
let UserController = class UserController {
    ...
    async confirmUser(email) {
        ...
        const mail = await this.emailService.sendMail(Object.assign(Object.assign({}, emailDto), { to: email, subject: 'email Verification', text: 'your verification code' }), user.verificationCode);
        return user;
    }
    findAll(role, status) {
    ...
    async sendSms() {
        await this.emailService.sendSms('+923135643338', 'safa you are selected for an interview please be prepared for the interview at sharp 2:00 pm today');
    }
};
__decorate([
    (0, swagger_1.ApiBody)(user_swagger_schema_1.UserSwaggerSchema.createUserBody),
    (0, common_1.Post)(),
...
__decorate([
    ...
    __param(1, (0, common_1.Query)('verificationCode')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "verifyUser", null);
__decorate([
    (0, common_1.Post)('/match/code'),
    __param(0, (0, common_1.Query)('email')),
    __param(1, (0, common_1.Query)('verificationCode')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "matchCode", null);
__decorate([
